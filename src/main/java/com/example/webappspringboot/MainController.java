...
//    }
    ...
    public String userDetailsForm() {
        // Add your logic here to display the sign-up form or perform other actions
        return "landingpage"; // Assuming "signup" is the name of your Thymeleaf signup.html template
    }
        ...
        if(credValue.isPresent()){
            if(credValue.get().getPassword().equals(password)){
                ...
                Optional<Usertypelink> usertypelink=usertypelinks.stream().
                        filter(usertypelink1->usertypelink1.getUsername().equals(username)).findAny();
